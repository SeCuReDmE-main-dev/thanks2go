...
| WebMCP cannot approve payment | 26 callback tests plus native Chrome discovery of all four tools; external webmcp.com grade B+ | four tools and bounded agent contract verified in production; directory indexing underway |
