...
| WebMCP cannot approve payment | 26 callback tests plus native Chrome discovery of all four tools; external webmcp.com grade B- | four tools verified in production; agent-perspective refinement pending rescan |
