...
| Mandate replay | Ten-minute expiry, signature verification, exact provider checks, and provider transaction signature as the receipt reference | Expiry/tamper tests and provider idempotency tests |
